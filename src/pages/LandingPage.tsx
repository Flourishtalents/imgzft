          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                role: 'Model & Actress',
                avatar: 'https://images.pexels.com/photos/1649735/pexels-photo-1649735.jpeg?auto=compress&cs=tinysrgb&w=150'
              },
              {
                name: 'Maya Chen',
                role: 'Event Manager',
              ...
              },
              {
                ...
                avatar: 'https://images.pexels.com/photos/8451911/pexels-photo-8451911.jpeg?auto=compress&cs=tinysrgb&w=150'
              }
            ].map((creator, index) => (
